...
<p align="center">
  ...
  <a href="https://github.com/axellero-io/eslint/blob/main/LICENSE">
   ...
   <a href="https://www.npmjs.com/package/@axellero/eslint-env">
     <img
       src="https://img.shields.io/npm/v/@axellero/eslint-env?color=blue&logo=npm&label="
       alt="@axellero/eslint-env"
     />
   </a>
</p>
...
```shell
$ yarn add -D @axellero/eslint-env
```
